...
Eo * _xml_sax_base_parse_string(Eo *obj, Xml_Base_Data *pd, const char *document);

EOAPI EO_FUNC_BODYV(xml_sax_base_parse_string, Eo *, 0, EO_FUNC_CALL(document), const char *document);
...
void _xml_sax_base_start(Eo *obj, Xml_Base_Data *pd, ElementData *elementData);

EOAPI EO_VOID_FUNC_BODYV(xml_sax_base_start, EO_FUNC_CALL(elementData), ElementData *elementData);

void _xml_sax_base_char(Eo *obj, Xml_Base_Data *pd, void *data, const xmlChar *string, int string_len);

EOAPI EO_VOID_FUNC_BODYV(xml_sax_base_char, EO_FUNC_CALL(data, string, string_len), void *data, const xmlChar *string, int string_len);

void _xml_sax_base_end(Eo *obj, Xml_Base_Data *pd, ElementData *data);

EOAPI EO_VOID_FUNC_BODYV(xml_sax_base_end, EO_FUNC_CALL(data), ElementData *data);
...
void _xml_sax_base_eo_base_constructor(Eo *obj, Xml_Base_Data *pd);


void _xml_sax_base_eo_base_destructor(Eo *obj, Xml_Base_Data *pd);
...
static Eo_Op_Description _xml_sax_base_op_desc[] = {
     EO_OP_FUNC_OVERRIDE(eo_constructor, _xml_sax_base_eo_base_constructor),
     EO_OP_FUNC_OVERRIDE(eo_destructor, _xml_sax_base_eo_base_destructor),
     ...
     EO_OP_FUNC(xml_sax_base_start, _xml_sax_base_start, "Called when XML node element start is hit"),
     EO_OP_FUNC(xml_sax_base_char, _xml_sax_base_char, "Called when XML characters are found within an element"),
     EO_OP_FUNC(xml_sax_base_end, _xml_sax_base_end, "Called when the end of an XML element is hit"),
