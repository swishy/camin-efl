 ...
 *
 */
EOAPI Eo * xml_sax_base_parse_string(const char *document);
 ...
 *
 */
EOAPI void  xml_sax_base_start(ElementData *elementData);
 ...
 *
 */
EOAPI void  xml_sax_base_char(void *data, const xmlChar *string, int string_len);
 ...
 *
 */
EOAPI void  xml_sax_base_end(ElementData *data);
